document.getElementById('currentHSAValue').value
document.getElementById('currentHSAValue').value
document.getElementById('currentHSAValue').value
document.getElementById('currentHSAValue').value
document.getElementById('currentHSAValue').value
...
function getLocalStorage() {
    for (const element of document.getElementsByTagName('input')) {
        ...
        console.log("Getting Value: " + element.id + "Value: " + element.value)
    }
}
...
function setLocalStorage() {
    for (const element of document.getElementsByTagName('input')) {
        ...
        console.log("Setting Value: " + element.id + "Value: " + element.value)
    }
}
